          ...
          <div style={{ display:'flex', alignItems:'flex-end', justifyContent:'space-between', marginTop:-44 }}>
            ...
            <div style={{ display:'flex', gap:8, paddingBottom:6 }}>
              {profile.instagram_url && (
                <a href={profile.instagram_url} target="_blank" rel="noopener noreferrer" className="kt-btn kt-btn-sm kt-btn-icon kt-btn-outline" title="Instagram">
              ...
              {profile.twitter_url && (
                <a href={profile.twitter_url} target="_blank" rel="noopener noreferrer" className="kt-btn kt-btn-sm kt-btn-icon kt-btn-outline" title="X / Twitter">
              ...
              {profile.threads_url && (
                <a href={profile.threads_url} target="_blank" rel="noopener noreferrer" className="kt-btn kt-btn-sm kt-btn-icon kt-btn-outline" title="Threads">
              ...
              <button onClick={() => setShowSocial(true)} className="kt-btn kt-btn-sm kt-btn-outline gap-1.5">
                <i className="ki-filled ki-plus text-xs" />
                {hasSocials ? 'Соцсети' : 'Добавить соцсети'}
              </button>
            </div>
          </div>
