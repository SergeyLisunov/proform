...
const PRINCIPLES = [
  ...
  {
    icon:  ShieldCheck,
    title: 'Канал доставки родителям',
    body:  'Родители получают разрешённые сведения по своему ребёнку — через PDF-снимки и email-рассылки. Не логин-роль, а канал доставки.',
  },
  {
    icon:  Database,
