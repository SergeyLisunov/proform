...
const ACCESS_MATRIX: AccessRow[] = [
  ...
  {
    role:       '📧 Родители (получатели)',
    sees:       'PDF-снимки и email-рассылки про своего ребёнка',
    doesNotSee: 'Личный кабинет (нет логина); данные других детей',
  },
  {
    role:       '🏛 Организация',
...
const PRINCIPLES = [
  {
    ...
    body:  'Тренер, спортсмен, врач и руководитель видят только то, что нужно им. Чужие данные недоступны — и это гарантирует сама база данных, а не настройки приложения.',
  },
  {
    icon:  Lock,
    title: 'Изоляция медданных',
    body:  'У врачей — отдельный закрытый контур. Тренер видит медицинскую информацию только тогда, когда врач сам ею делится. По умолчанию — нет.',
  },
  {
    icon:  ShieldCheck,
    title: 'Row-Level Security',
    body:  'Каждый запрос к данным проходит проверку прав на уровне PostgreSQL. Даже при взломе сервера приложения чужие карточки остаются недоступны.',
  },
  {
    icon:  Database,
    title: 'Полный аудит действий',
    body:  'Руководитель клуба видит, кто, что и когда менял. Прозрачность для контроля и быстрый разбор любых спорных ситуаций.',
  },
]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="max-w-3xl">
          <p className="text-2xs font-bold uppercase tracking-[0.24em] text-orange-400">
            Медицинский контур и защита данных
          </p>
          <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">
            Медкарты под защитой — доступ только тем, кому положено
          </h2>
          <p className="mt-4 text-base leading-relaxed text-slate-300">
            Здоровье спортсменов — чувствительные данные. В Sporteo каждая роль
            видит только своё, медданные изолированы, а защита встроена в саму
            базу — а не зависит от настроек администратора.
          </p>
        </div>
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-5">
          <p className="text-xs leading-relaxed text-slate-400">
            ...
            Политики Row-Level Security на каждой таблице ·
