 ...
 * proof-пойнты: работающий MVP, научный контроль нагрузки (ACWR),
 * отзывы спортивных федераций, протестированная интеграция с носимыми
 * устройствами и руководство —
...
const BLOCKS: TrustBlock[] = [
  ...
  {
    icon:        Activity,
    title:       'Контроль нагрузки на научной основе (ACWR)',
    description:
      'Система автоматически считает соотношение острой и хронической нагрузки (ACWR) по методике Gabbett и подсвечивает зону риска перегрузки заранее — у тренера есть время снизить нагрузку, а не констатировать травму постфактум.',
  },
  {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
            Рабочая платформа, научный контроль нагрузки (ACWR), отзывы
            федераций и команда уровня спорта высоких достижений. Не слова —
            факты, на которые можно опереться при выборе.
          </p>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-3xl border-2 border-dashed border-orange-200 bg-orange-50/40 p-6 text-center">
          <p className="flex flex-col items-center gap-3 text-sm leading-relaxed text-muted-foreground sm:flex-row sm:items-start sm:text-left">
            ...
            />
            <span>
              <strong className="text-orange-700">Связка, которой нет у CRM:</strong>{' '}
              врач, тренер и контроль нагрузки в одном продукте — то, чего нет
              у обычных дневников и студийных CRM. Лучший способ убедиться —
