...
const BLOCKS: TrustBlock[] = [
  {
    ...
    description:
      'Каждый подключаемый клуб получает персональный звонок с командой ProForm + миграцию первичных данных + приоритетную поддержку первые 30 дней.',
  },
  {
    icon:        Globe2,
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
            ProForm в закрытой бете — реальные отзывы клубов появятся,
