 ...
 *
 * 3 карточки целевых клиентов Sporteo: частная академия / клуб,
...
const STORIES: CustomerStory[] = [
  {
    name:         'Частная академия и спортклуб',
    role:         'Руководителю академии и старшему тренеру',
    ...
    quote:
      ...
      'и не теряются при смене тренера. Сводка по академии — в один клик, а не за полдня.',
    outcome:      'Единая картина по всей академии',
    hue:          HUE.blue,
  },
  {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted-foreground sm:text-lg">
            Частные академии, команды с врачом, сети клубов — у каждого свой
        ...
        <p className="mx-auto mt-8 max-w-3xl text-center text-xs leading-relaxed text-muted-foreground">
          ...
          Контроль нагрузки на научной основе (ACWR по методике Gabbett),
          защита медданных на уровне СУБД (Row-Level Security), интеграция с
          умными устройствами протестирована. Подписка — от 3900 ₽ в месяц.
        </p>
      </div>
    </section>
  )
