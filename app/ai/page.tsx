  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition-all ${
        active
          ? 'bg-linear-to-r from-[#7C3AED] to-[#5B21B6] text-white shadow-md shadow-purple-500/25'
      ...
      <div className={shell} style={{ minHeight: 420 }}>
        ...
        {caps?.upgrade && (
          <Link
            ...
            className="rounded-xl bg-linear-to-r from-[#7C3AED] to-[#5B21B6] px-5 py-2.5 text-sm font-semibold text-white shadow-xs transition-all hover:shadow-md no-underline"
          >
            {caps.upgrade.cta}
          </Link>
        )}
  ...
  return (
    <div className={shell} style={{ minHeight: 420 }}>
      ...
      <button
        ...
        className="rounded-xl bg-linear-to-r from-[#7C3AED] to-[#5B21B6] px-5 py-2.5 text-sm font-semibold text-white shadow-xs transition-all hover:shadow-md"
      >
...
export default function AiHubPage() {
  ...
  return (
    <div className="flex flex-col gap-6 pf-page-enter">
      {/* Header */}
      <div className="relative overflow-hidden rounded-3xl border border-[#E9D5FF] bg-linear-to-br from-[#FAF5FF] via-white to-[#F0F9FF] p-6 md:p-8">
