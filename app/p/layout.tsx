  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-foreground">
      <header className="border-b border-border bg-card">
        <div className="mx-auto max-w-5xl px-5 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-3 text-sm">
            <Link href="/tools/acwr" className="text-slate-600 hover:text-foreground hidden sm:inline">ACWR</Link>
      ...
      <footer className="border-t border-border bg-muted mt-16">
        <div className="mx-auto max-w-5xl px-5 py-6 text-xs text-muted-foreground flex items-center justify-between">
