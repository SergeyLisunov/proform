...
const ROLE_GROUPS: Array<{ key: string; label: string; emoji: string; bg: string; color: string }> = [
  { key: 'athlete',      label: 'Атлет',           emoji: '🏃', bg: '#FFF7ED', color: '#EA580C' },
                    ...
                    {isPopular && (
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                        <span className="rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-wider"
                          style={{ background: 'linear-gradient(135deg,#F97316,#EA580C)', color: 'white', boxShadow: '0 4px 12px rgba(234,88,12,0.4)' }}>
                          ⭐ Популярный
                        </span>
                      </div>
                    )}
